<div class="page-wrapper">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
							...
							<div class="dash-widget-info text-right">
								<h3><?= empty($dc)?'0':$dc ?></h3>
								<span class="widget-title1">Post <i class="fa fa-user" aria-hidden="true"></i></span>
							</div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                <h3><?= empty($pc)?'0':$pc ?></h3>
                                <span class="widget-title2">Total User<i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
				...
				<!--				<h4 class="card-title d-inline-block">Upcoming Appointments</h4> <a href="<?= base_url() ?>Appointment" class="btn btn-primary float-right">View all</a>-->
				<!--			</div>-->
    ...
    <!--                </div>-->
				...
				<!--		<div class="card">-->
				<!--			<div class="card-header">-->
				<!--				<h4 class="card-title d-inline-block">New Patients </h4> <a href="<?= base_url()?>Patient" class="btn btn-primary float-right">View all</a>-->
				<!--			</div>-->
