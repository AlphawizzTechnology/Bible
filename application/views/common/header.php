       ...
       <div class="header">
			...
			<div class="header-left">
				<a href="<?= base_url() ?>" class="logo">
					<img src="<?= base_url() ?>assets/img/logo.png" width="35" height="55" alt=""> <span>Bible</span>
				</a>
            </div>
            ...
            <ul class="nav user-menu float-right">
              <!--   <li class="nav-item dropdown d-none d-sm-block">
               ...
               <?php $admin_data = $this->session->userdata('admin');?>
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="<?= base_url() ?>assets/img/logo.png" width="40" alt="Admin">
