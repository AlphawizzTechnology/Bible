                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <?php $url = $this->uri->segment(1); ?>
						...
						<li class="<?= ($url =='Doctor')?'active':'' ?>">
                            <a href="<?= base_url() ?>Doctor"><i class="fa fa-user-md"></i> <span>Post</span></a>
                        </li >
                        <li class="<?= ($url =='Patient')?'active':'' ?>" >
                            <a href="<?= base_url() ?>Patient"><i class="fa fa-wheelchair"></i> <span>User</span></a>
                        </li>
                        <!--<li class="<?= ($url =='Appointment')?'active':'' ?>">-->
                        <!--    <a href="<?= base_url() ?>Appointment"><i class="fa fa-calendar"></i> <span>Appointments</span></a>-->
                        <!--</li>-->
